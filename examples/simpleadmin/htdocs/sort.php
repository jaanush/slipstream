...
<body class="tundra">
			<div id="grid1" sort="[{attribute: 'order', descending: true}]" jsId="grid1" structure="layout" query="{id:'*'}" store="store" queryOptions="{cache:true,sort:[{attribute: 'order', descending: true}]}" rowSelector="20px" selectionMode="single" dojoType="dojox.grid.EnhancedGrid" plugins="{nestedSorting: {sortAttrs:[{attr: 'order', asc: 1}]}, dnd: true, indirectSelection: true}" style="height: 100%">
			</div>
</body>
</html>